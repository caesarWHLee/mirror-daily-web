 ...
 */
export function gql(
  source: 'query GetExternalById($id: ID!) {\n  external(where: {id: $id}) {\n    id\n    title\n    thumb\n    extend_byline\n    publishedDate\n    brief\n    content\n    tags {\n      name\n      slug\n    }\n  }\n}\n\nquery GetRelatedPostsByExternalId($id: ID!) {\n  external(where: {id: $id}) {\n    relateds {\n      ...RelatedPost\n    }\n  }\n}\n\nquery GetExternalsByPartnerSlug($skip: Int!, $take: Int!, $slug: String!) {\n  externals(\n    skip: $skip\n    take: $take\n    where: {partner: {slug: {equals: $slug}}}\n    orderBy: {publishedDate: desc}\n  ) {\n    id\n    title\n    brief\n    publishedDate\n    thumb\n  }\n}'
): (typeof documents)['query GetExternalById($id: ID!) {\n  external(where: {id: $id}) {\n    id\n    title\n    thumb\n    extend_byline\n    publishedDate\n    brief\n    content\n    tags {\n      name\n      slug\n    }\n  }\n}\n\nquery GetRelatedPostsByExternalId($id: ID!) {\n  external(where: {id: $id}) {\n    relateds {\n      ...RelatedPost\n    }\n  }\n}\n\nquery GetExternalsByPartnerSlug($skip: Int!, $take: Int!, $slug: String!) {\n  externals(\n    skip: $skip\n    take: $take\n    where: {partner: {slug: {equals: $slug}}}\n    orderBy: {publishedDate: desc}\n  ) {\n    id\n    title\n    brief\n    publishedDate\n    thumb\n  }\n}']
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
  source: 'query GetPartnerInformation($slug: String!) {\n  partner(where: {slug: $slug}) {\n    name\n  }\n}'
): (typeof documents)['query GetPartnerInformation($slug: String!) {\n  partner(where: {slug: $slug}) {\n    name\n  }\n}']
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
